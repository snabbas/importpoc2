...
namespace ImportPOC2.Processors
{
    ...
    public class CriteriaProcessor
    {
        ...
        public void CreateNewValue(string criteriaCode, object value, long setCodeValueId, string valueTypeCode = "LOOK", string valueDetail = "", string optionName = "", bool setFormatValue = true)
        {
            var cSet = GetCriteriaSetByCode(criteriaCode, optionName);
